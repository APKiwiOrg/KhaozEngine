...
public static class ItemsBenchmarkReport
{
    public static void Write(ItemsBenchmarkResult result, TextWriter output)
    {
        ...
        output.WriteLine(string.Create(culture, $"budget 5 cost shape: {result.Budget5DeadEntriesPerGeneration:F1} dead entries walked per generation, {result.Budget5InvariantViolations} invariant violations"));
