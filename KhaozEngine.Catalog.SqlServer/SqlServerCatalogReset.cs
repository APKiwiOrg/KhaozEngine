...
/// number must REBUILD its pack root through <c>ContentPackRebuild</c>, rather than leave that to the boot to
/// notice. The hashes that STOOD come back on <see cref="ContentCatalogResetResult"/>, which is the last
