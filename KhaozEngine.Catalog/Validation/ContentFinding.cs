...
/// <para>
/// A VALUE, so a sweep over a million rows accumulates its findings without a million small objects, and so
/// an untrusted per-type validator cannot hand back a null the engine then has to defend against.
/// </para>
/// </summary>
