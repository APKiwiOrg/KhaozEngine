...
10.4 (fences and the empty `WaitForIdle`), section 6 (per-frame memory), sections 9.1 and 9.2 (the swapchain, the
present path and the resize), and decisions P1, P2, P4, I2, R1, R2, R3, R4, R6, R8, W1, W2, W3, W6, T2, U1, U2,
U3, U4, U5, X1, X2, X3, S2, C2, C5 and C6. The recorded non-measurement M5 in section 13 is the swapchain's, and
its wording is reproduced above rather than referenced, because a reader of a soak capture will not have the
design doc open.
