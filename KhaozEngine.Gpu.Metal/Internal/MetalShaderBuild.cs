...
namespace KhaozEngine.Gpu.Metal.Internal
{
    ...
    /// <c>ComputePipelineDescription.ThreadGroupSize*</c>, which is that same source one layer up.
    /// </para>
    /// </summary>
    internal static class MetalShaderBuild
    {
        ...
        internal static MetalMslProgram Pair(string vertexGlsl, string fragmentGlsl, string? label = null)
        {
            ArgumentNullException.ThrowIfNull(vertexGlsl);
            ArgumentNullException.ThrowIfNull(fragmentGlsl);

            string tag = label ?? "metal program " + MetalShaderKey.ShortTag(
                MetalShaderKey.For(vertexGlsl, fragmentGlsl));
            ...
            return Assemble(msl.Reflection, tag,
            ...
            string? label = null)
        {
            ...
            string tag = label ?? "metal compute " + MetalShaderKey.ShortTag(MetalShaderKey.For(computeGlsl));
