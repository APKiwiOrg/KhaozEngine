...
namespace KhaozEngine.Gpu.Metal
{
    ...
    /// message naming the row that builds it (https://github.com/APKiwiOrg/KhaozEngine/issues/570).
    ...
    public static class KhaozEngineMetal
    {
        ...
        /// </para>
        /// <para>
        /// It does not get to outlive its reason. <c>MetalBackendRegistrationTests</c> in
        /// <c>KhaozEngine.Render.Tests</c> fails the moment ordinal 6 gains a name, and its message is the
        /// instruction: replace this cast with <c>GpuBackendKind.MetalNative</c> and delete the test. A magic
        /// number nobody is forced to remove is how a temporary shim becomes permanent.
        /// </para>
        /// </summary>
        internal const GpuBackendKind MetalNativeKind = (GpuBackendKind)6;
