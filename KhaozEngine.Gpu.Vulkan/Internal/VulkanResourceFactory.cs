...
namespace KhaozEngine.Gpu.Vulkan.Internal
{
    ...
    /// creation here that makes no native object at all (V-A1). Shader sets are row 16's and pipelines are row
    /// 13's, and each refuses with
    ...
    internal sealed class VulkanResourceFactory : IGpuResourceFactory
    {
        ...
        static NotSupportedException NotBuiltYet(string what, string row)
            => new($"{what} is not built yet on the native Vulkan backend: it lands in {row}. Buffers, textures, "
                + "samplers, command lists, fences, resource layouts, resource sets and framebuffers ARE live "
                + "(work-breakdown rows 9, 10 and 12, https://github.com/APKiwiOrg/KhaozEngine/issues/519, "
                + "https://github.com/APKiwiOrg/KhaozEngine/issues/520 and "
                + "https://github.com/APKiwiOrg/KhaozEngine/issues/522). This is a statement about the package and "
