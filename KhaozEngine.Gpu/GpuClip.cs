...
{
    /// <summary>
    /// Adapts a world-&gt;clip view-projection to the live backend's clip-space convention. Veldrid backends
    ...
    /// rendering is byte-identical. The Y-flip branch activates on inverted-Y backends (Vulkan), following
    /// Veldrid's <c>IsClipSpaceYInverted</c> contract; it is not yet validated on non-Metal hardware.
    /// </remarks>
