...
/// and its S256 challenge (base64url(SHA256(ASCII(verifier)))). Duplicated from KhaozEngine.Identity.Oidc's
/// internal helper (same stable algorithm) so this package does not depend on the Oidc sibling package.</summary>
