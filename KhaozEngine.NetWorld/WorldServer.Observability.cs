...
// reads in one place instead of trailing the session plumbing in WorldServer.cs. #267 wired the pending-connection
// pair through. #786 put the drop counter beside it, because a game could see a refused connect but not a dropped
// session event on the same inbox. Split out by concern, as WorldServer.Pickups.cs is, and because WorldServer.cs
...
public sealed partial class WorldServer
{
    ...
    /// <see cref="WorldServerConfig.MaxQueuedEvents"/>. Non-zero means this host is not draining as
