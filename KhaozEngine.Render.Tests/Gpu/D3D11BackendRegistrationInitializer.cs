...
namespace KhaozEngine.Tests.Gpu
{
    ...
    /// <para>
    /// <c>GpuTestGate</c> is the braces, and <see cref="GpuFactAttribute"/> reaches it when xUnit's discovery pass
    /// reads that attribute. This assembly also
    ...
    /// gate cannot register two different things or register twice.
    /// </para>
    /// </summary>
