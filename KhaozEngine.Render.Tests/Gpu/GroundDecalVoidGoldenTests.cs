...
namespace KhaozEngine.Tests.Gpu
{
    ...
    /// with a per-channel tolerance (0.06 then, 0.01 since the golden audit), and 11.9.0 proved that grid cannot
    /// see fine or sparse detail at all (the starfield golden passed with the starfield pass commented out
    /// entirely, see <see href="https://github.com/APKiwiOrg/KhaozEngine/issues/19"/>). The ring
