...
namespace KhaozEngine.Tests.Gpu
{
    ...
    /// <see cref="PropRenderer.DrawProps(Scene3D, System.Collections.Generic.IReadOnlyList{PropPlacement}, System.Collections.Generic.IReadOnlyDictionary{string, MeshHandle}, Vector3, float, Color?, float, System.Collections.Generic.IReadOnlyDictionary{string, MeshHandle}, float, float, bool, System.Collections.Generic.IReadOnlyDictionary{string, float})"/>
