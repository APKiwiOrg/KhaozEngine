...
namespace KhaozEngine.Tests.Render3D
{
    ...
    public sealed class WaterClipmapTests
    {
        ...
        public void TheTwoVertexSourcesDifferOnlyInTheirGridInputs()
        {
            ...
            Assert.Contains("gerstnerEvaluate(aXz, time, swellOffset, swellNormal, swellFold);", plain);
            Assert.Contains("gerstnerEvaluate(aXz, time, swellOffset, swellNormal, swellFold);", clip);
