...
namespace KhaozEngine.Tests.Terrain
{
    ...
    /// <see cref="PropLayer.PlacementLayer(IPlacementSource, IReadOnlyDictionary{string, MeshHandle}, float, float, IReadOnlyDictionary{string, MeshHandle}, float, bool, bool, IReadOnlyDictionary{string, float})"/>
