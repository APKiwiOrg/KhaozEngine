...
///
/// Per-assembly copy of the helper the Render and Foundation tests carry, for the same reason the collection
/// definition is copied per assembly. Brought into this assembly by issue #264, whose nine sightings of
/// <c>ShardHostOwnerIndexAllocationTests.TryGetOwner_HotLookups_AllocateNothing</c> are all of that shape.
/// </summary>
