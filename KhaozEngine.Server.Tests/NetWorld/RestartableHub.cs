...
/// <summary>
/// A test harness for reconnect: holds the "current" <see cref="InMemoryTransportHub"/>, hands a <see cref="KhaozEngine.NetWorld.WorldClient"/>
...
{
    public InMemoryTransportHub Current { get; private set; } = new();
    ...
    public void Restart() => Current = new InMemoryTransportHub();
}
