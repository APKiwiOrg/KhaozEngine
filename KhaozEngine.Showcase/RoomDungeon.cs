...
namespace KhaozEngine.Showcase
{
    ...
    public sealed class RoomDungeon : GameScene, IGameScene3D, IShowcaseRoom
    {
        ...
        // players), one local entity (id 0) scaled to this room's capsule. Shared with Room3D and RoomNet through
        // CharacterRigLoader. On any load failure the room falls back to the greybox capsule (_animated stays false).
