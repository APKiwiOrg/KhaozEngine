...
namespace KhaozEngine.Tests.Gpu
{
    ...
    /// KhaozEngine.Gpu (the backend boundary) + Windowing's internal SDL2 window/input. A future Silk.NET backend
    /// is then a new IGpuDevice impl, not a consumer-visible change. This reflection test fails the build if any
