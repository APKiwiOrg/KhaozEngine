...
public class TileCombatTargetTests
{
    ...
    public void Attack_is_its_own_command_kind_and_rides_the_existing_fixed_frame()
    {
        ...
        // InteractEntity owns kind 4 and Steer owns kind 5. The next value is still malformed, because an
        // unchecked byte cast into an enum reaches a switch that has no case for it.
        frame[5] = 6;
