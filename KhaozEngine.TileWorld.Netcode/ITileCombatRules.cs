...
/// because a fight with invisible misses reads as a broken fight.</param>
...
public interface ITileCombatRules
{
    ...
    /// because the attack cadence is exactly the kind of number a feel round moves.</summary>
