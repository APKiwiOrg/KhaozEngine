...
/// (in-place self-update is Windows-only today). The shim passes <see cref="CreateForCurrentOs"/> as the
/// factory to <c>UpdateApplier.Run</c>, so no window code is reachable off Windows.
/// </summary>
