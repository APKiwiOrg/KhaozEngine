...
**Engine current version:** `7.15.1` (the shared `<KhaozEngine5xVersion>` line, which is the engine): the
...
`KhaozEngine.Updates.Tool` package (the `ke-updater` dotnet tool: manifest/genkey/sign/verify), and 7.15.1 adds
