...
| Account registry | `../KhaozEngine.Accounts/IAccountStore.cs`, `AccountRecord.cs`, `AccountSignIn.cs`, `AccountStoreRules.cs` | `../KhaozEngine.Accounts/InMemoryAccountStore.cs`, `AccountBanStore.cs`, conformance in `../KhaozEngine.Accounts.Tests/AccountStoreConformance*.cs` |
