...
| [PARTICLE-ATTRACTOR-DESIGN-2026-07-20.md](design/PARTICLE-ATTRACTOR-DESIGN-2026-07-20.md) | `ParticleAttractor`: system-level state over per-particle tagging, one player-level attractor forwarded to every phase pool, `IgnoreAttractor` as a bool opt-out rather than a graduated influence weight, why the pull appends after turbulence and absorb checks post-integration, and why emission-rate modulation is two knobs (`RateCurve` authored, `RateScale` runtime) for two different drivers. | **Complete.** Shipped 14.6.0, closing [#255](https://github.com/APKiwiOrg/KhaozEngine/issues/255). Second half of the Ruinborne death pass. Consumer is [Ruinborne#120](https://github.com/APKiwiOrg/Ruinborne/issues/120). |
