...
| [TERRAIN-SCULPT-LAYER-DESIGN.md](design/TERRAIN-SCULPT-LAYER-DESIGN.md) | The terrainOverrides sculpt-delta layer (map format v2): authored height deltas composited inside TerrainField, editor brushes, sculpt MCP verbs. | **In flight.** Approved 2026-07-23, phases T1-T3 pending (#271). |
