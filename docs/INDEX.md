...
| [AAA-VFX-TIER1-DESIGN-2026-07-16.md](AAA-VFX-TIER1-DESIGN-2026-07-16.md) | The approved AAA VFX Tier 1 design: the HDR float16 chain + ACES filmic tonemap + pre-tonemap bloom (default on, byte-identical legacy opt-out, unclamped `Color` as the over-1.0 authoring surface), with flipbook-particle and screen-space-distortion sections added as those sub-features land. | The Tier 1 VFX design rationale while the program is in flight (shipped pieces move to CHANGELOG/USING/README as they land). |
