...
| [FILESIZE-ANALYZER-DESIGN-2026-07-20.md](design/FILESIZE-ANALYZER-DESIGN-2026-07-20.md) | File-size ratchet as a compile-time Roslyn analyzer (KESIZE001/002), fleet rollout | **Shipped (14.6.0).** Program issue [#254](https://github.com/APKiwiOrg/KhaozEngine/issues/254). |
