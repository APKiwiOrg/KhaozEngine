...
```xml
<PackageReference Include="KhaozEngine.Physics.Bepu" Version="17.34.0" />
```
...
```xml
<PackageReference Include="KhaozEngine.Gpu.D3D11" Version="17.34.0" />
```
...
```xml
<PackageReference Include="KhaozEngine.Gpu.Vulkan" Version="17.34.0" />
```
