...
3. `ke-mapedit` (shipped, `KhaozEngine.MapEdit.Tool`) absorbs these as verbs 1:1, now that this
   generator has shipped too (`KhaozEngine.Dungeon`). Nothing thrown away.
