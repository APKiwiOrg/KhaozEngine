...
17.3.0 as `WaterSettings.ClipmapGeomorphBand`, which takes the 0.00086 m residual above to 0.00047 m at its
...
- ~~**LOD morph across ring boundaries** to remove the remaining 12 per cent
  ([#348](https://github.com/APKiwiOrg/KhaozEngine/issues/348)).~~ Shipped in 17.3.0; see above.
