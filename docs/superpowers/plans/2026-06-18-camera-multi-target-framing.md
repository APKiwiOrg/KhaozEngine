...
In `Directory.Build.props`, change `<KhaozEngine5xVersion>5.52.0</KhaozEngine5xVersion>` to `5.53.0`.
...
Expected: exit 0 (declarations match `<KhaozEngine5xVersion>` = 5.53.0).
