...
In `Directory.Build.props`, change `<KhaozEngine5xVersion>5.54.0</KhaozEngine5xVersion>` to `5.55.0`.
...
Expected: exit 0 (declarations match `<KhaozEngine5xVersion>` = 5.55.0).
